...
contract CustomCrowdsale is CappedCrowdsale, Ownable {
    using SafeMath for uint256;

    uint256 _startTime = {{start_time}};
    uint256 endTime = {{end_time}};
    uint256 rate = {{rate}};
    uint256 cap = {{cap}};
    address wallet = {{wallet}};
    address tokenAddress = {{token_address}};

    function CustomCrowdsale(uint256 _startTime, uint256 _endTime, uint256 _rate, uint256 _cap, address _wallet, address _tokenAddress) 
